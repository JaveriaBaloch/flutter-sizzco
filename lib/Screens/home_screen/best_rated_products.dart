...
class BestRatedProductsPage extends StatefulWidget {
  @override
  State<BestRatedProductsPage> createState() => _BestRatedProductsPageState();
}

class _BestRatedProductsPageState extends State<BestRatedProductsPage> {
  ...
  Future<List<WooCommerceProduct>> _getProducts() async {
    try {
      final response = await http.get(Uri.parse(
          'https://sizzco.com/wp-json/wc/v3/products?consumer_key=${Config().ck}&consumer_secret=${Config().cs}&orderby=rating'));
