...
class NewArrivalsProductsPage extends StatefulWidget {
  @override
  State<NewArrivalsProductsPage> createState() =>
      _NewArrivalsProductsPageState();
}

class _NewArrivalsProductsPageState extends State<NewArrivalsProductsPage> {
  ...
  Future<List<WooCommerceProduct>> _getProducts() async {
    try {
      final response = await http.get(Uri.parse(
          'https://sizzco.com/wp-json/wc/v3/products?consumer_key=${Config().ck}&consumer_secret=${Config().cs}&orderby=date&order=desc'));
          ...
          return Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (product.name != "Product" && product.price != null) {
                    discount = (100 -
