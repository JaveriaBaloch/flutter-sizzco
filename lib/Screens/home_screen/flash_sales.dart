...
class WooCommerceProductsPage extends StatefulWidget {
  @override
  State<WooCommerceProductsPage> createState() =>
      _WooCommerceProductsPageState();
}

class _WooCommerceProductsPageState extends State<WooCommerceProductsPage> {
  Future<List<WooCommerceProduct>> _getProducts() async {
    try {
      final response = await http.get(Uri.parse(
          'https://sizzco.com/wp-json/wc/v3/products?consumer_key=${Config().ck}&consumer_secret=${Config().cs}&on_sale=true'));
