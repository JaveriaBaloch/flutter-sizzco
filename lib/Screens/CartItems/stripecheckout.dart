...
class StripePaymentCheckoutScreen extends StatefulWidget {
  const StripePaymentCheckoutScreen({Key? key}) : super(key: key);

  @override
  _StripePaymentCheckoutScreenState createState() => _StripePaymentCheckoutScreenState();
}

class _StripePaymentCheckoutScreenState extends State<StripePaymentCheckoutScreen> {
